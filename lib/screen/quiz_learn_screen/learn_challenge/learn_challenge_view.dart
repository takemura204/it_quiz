    ...
    return Expanded(
      child: Stack(
        ...
        children: [
          ...
          //   cardCount: quizItemList.length,
          //   loop: true,
          //   backgroundCardCount: (quizIndex + 1 == quizItemList.length) ? 0 : 1,
          ...
          //   maxAngle: 90,
          //   swipeOptions:
          //       const SwipeOptions.symmetric(horizontal: true, vertical: false),
          // onCardPositionChanged: (SwiperPosition direction) {
          //     // スワイプが完全に終了した時の処理

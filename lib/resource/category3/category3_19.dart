...
List<QuizItem> get category3_19 {
  final quizItems = [
    QuizItem(
      ...
      comment:
          "LAN(Local Area Network)は、同じ建物の中など、比較的狭い範囲(広くても同じ施設内程度の規模)のコンピュータ間で通信を実現するネットワーク。",
    ...
    QuizItem(
      ...
      comment:
          "ゲートウェイは、OSI基本参照モデルの7層すべてを認識するが、主にトランスポート層以上で通信プロトコルの異なるネットワーク同士を接続する役割を持つ通信装置や機能。",
      importance: QuizImportanceType.low,
    ),
    QuizItem(
      word: 'デフォルトゲートウェイ',
      ...
      comment:
          "デフォルトゲートウェイは、プライベートネットワークに存在しない機器と通信を行うときに、外部ネットワークとの接続点となる機器のこと。",
      source: '平成28年秋期 問64',
      importance: QuizImportanceType.low,
    ),
    QuizItem(

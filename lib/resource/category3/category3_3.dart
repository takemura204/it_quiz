...
List<QuizItem> get category3_3 {
  final quizItems = [
    ...
    QuizItem(
      ...
      comment: "キューは、先入れ先出し（FIFO：First In First Out）の原則に基づいて動作するデータ構造で、データの追加は末尾から、削除は先頭から行われる。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'スタック',
      ...
      comment: "スタックは、後入れ先出し（LIFO：Last In First Out）の原則に基づいて動作するデータ構造で、データの追加と削除が同じ側（トップ）から行われる。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: '木構造',
  ...
  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + I18n().category3Index + 301);
  });
}

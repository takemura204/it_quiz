...
List<QuizItem> get category3_24 {
  final quizItems = [
    ...
    QuizItem(
      ...
      comment: "コールバックは、リモートアクセスセッションのセキュリティを強化するために、あらかじめ登録された電話番号にのみ折り返し接続を行う方法。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'アクセス制御',
    ...
    QuizItem(
      ...
      comment: "IDS（Intrusion Detection System）は、ネットワーク上の不審な活動や攻撃の兆候を検出し、警告を発するシステム。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      ...
      comment: "IPS（Intrusion Prevention System）は、攻撃を検出し、自動的にそれを阻止または軽減するためのセキュリティシステム。",
      importance: ImportanceType.low,
    ),
    QuizItem(
    ...
    QuizItem(
      ...
      comment: "DLP（Data Loss Prevention）は、機密情報が組織の外部に漏洩するのを防ぐために、データの流れを監視し、必要に応じて制御する技術。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: '検疫ネットワーク',
    ...
    QuizItem(
      ...
      comment: "電子透かし技術とは、デジタルコンテンツに作者名・課金情報・コピー可能回数など著作権情報を目で確認するのが困難な状態で埋め込む技術。",
      source: '平成22年春期 問74',
      importance: ImportanceType.normal,
    ),
    QuizItem(
    ...
    QuizItem(
      ...
      comment: "ペネトレーションテスト(侵入テスト)は、ネットワークに接続されているシステムに対して、実際に様々な方法で侵入を試みることで脆弱性の有無を検査するテスト。",
      source: '平成26年秋期 問62',
      importance: ImportanceType.normal,
    ),
    QuizItem(
    ...
    QuizItem(
      ...
      comment: "セキュアブートは、コンピュータが信頼できるソフトウェア、例えば正規のオペレーティングシステムからのみ起動することを保証するセキュリティプロセス。",
      importance: ImportanceType.low,
    ),
    QuizItem(
    ...
    QuizItem(
      ...
      comment: "クリアスクリーンポリシーは、退席時にコンピュータの画面をロックするなどして、画面上の情報が他人に見られることを防ぐためのセキュリティポリシー。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: '共通鍵暗号方式',
      ...
      comment: "共通鍵暗号方式は、秘密鍵暗号方式とも呼ばれ、暗号化と復号に同一の鍵を用いる方式で、代表的なアルゴリズムに、DESやAESがある。",
      source: '平成27年春期 問73',
      importance: ImportanceType.normal,
    ),
    QuizItem(
      ...
      comment: "公開鍵暗号方式（非対称鍵暗号方式）は、暗号化に公開鍵を、復号には対応する秘密鍵を使用する暗号方式。公開鍵は公開され、秘密鍵は所有者のみが保持する。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'ハイブリッド暗号方式',
    ...
    QuizItem(
      ...
      comment: "ディジタル署名は、公開鍵暗号技術を応用してデジタル文書の正当性を保証する技術で、この技術を利用すると「発信元が正当であるか」と「改ざんの有無」の2点が確認される。",
      source: '平成27年春期 問78',
      importance: ImportanceType.high,
    ),
    QuizItem(
      ...
      comment: "タイムスタンプは、ドキュメントやデータが特定の時点で存在していたことを証明するために使用される、信頼できる第三者によって提供されるサービス。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'ワンタイムパスワード',
    ...
    QuizItem(
      ...
      comment: "SMS認証は、ログインやトランザクションの確認のために、ユーザーの携帯電話にSMSメッセージを通じて一時的な認証コードを送信する認証方法。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'CAPTCHA',
    ...
    QuizItem(
      ...
      comment: "認証局(CA)は、公開鍵暗号方式を用いたデータ通信において、利用者の公開鍵の正当性を保証するためのデジタル証明書を発行する機関。",
      source: '平成21年秋期 問85',
      importance: ImportanceType.normal,
    ),
    QuizItem(
    ...
    QuizItem(
      ...
      comment: "セキュリティバイデザインは、製品やシステムの設計初期段階からセキュリティを組み込むことを重視するアプローチ。予防的なセキュリティ対策を促進する。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'プライバシーバイデザイン',
  ...
  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + I18n().category3Index + 2401);
  });
}

...
List<QuizItem> get category3_1 {
  final quizItems = [
    ...
    QuizItem(
      ...
      comment: "グラフ理論は、ノード（頂点）とエッジ（辺）から構成されるグラフと呼ばれる数学的構造を研究する理論で、ネットワーク分析などに応用される。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: '最適化問題',
      ...
      comment: "最適化問題は、ある制約条件のもとで目的関数の最大値または最小値を求める問題で、数学や工学、経済学など多岐にわたる分野で応用される。",
      importance: ImportanceType.low,
    ),
  ];

  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + I18n().category3Index + 101);
  });
}

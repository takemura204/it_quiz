...
List<QuizItem> get category1_15 {
  final quizItems = [
    ...
    QuizItem(
      ...
      comment: "シミュレーションは、現実世界の物理的な挙動をコンピュータ上でモデル化し再現する技術。事前に性能や問題点を予測し、開発や改善に役立てる。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'センシング技術',
      ...
      comment: "センシング技術は、温度、圧力、光などの物理的な変化を検出し、それを電気信号などのデータとして取得する技術。多様な分野での応用が可能。",
      importance: ImportanceType.normal,
    ),
    QuizItem(
      word: 'JIT',
      question: 'ジャストインタイム生産方式を説明したものはどれか。',
      ans: '必要な物を，必要なときに，必要な量だけ生産する方式',
      choices: [
    ...
    QuizItem(
      ...
      comment: "リーン生産方式は、無駄を徹底的に排除し、必要最小限のリソースで価値ある製品を生産することを目指す生産管理のアプローチ。トヨタ生産方式とも呼ばれる。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'かんばん方式',
      ...
      comment: "かんばん方式は、製造ラインにおいて必要な部品や材料、情報を「かんばん（看板）」と呼ばれる情報伝達ツールを用いて視覚的に管理し、ジャストインタイム生産を支援する方法。",
      importance: ImportanceType.low,
    ),
  ];

  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + I18n().category1Index + 1501);
  });
}

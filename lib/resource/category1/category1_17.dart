...
List<QuizItem> get category1_17 {
  final quizItems = [
    ...
    QuizItem(
      question: '元請け企業が下請け企業に対して代金の支払いを遅延することを防ぐための法律は何か？',
      ans: '下請代金支払遅延等防止法',
      choices: ["下請代金支払遅延等防止法", "独占禁止法", "支払遅延利息法", "商法"],
      comment:
          "下請代金支払遅延等防止法は、元請け企業が下請け企業に対して代金の支払いを適正な期間内に行うことを義務付け、支払い遅延を防ぐための法律。",
    ),
    QuizItem(
      question: '金融商品の適切な取引を確保し、投資家を保護するための法律は何か？',
      ans: '金融商品取引法',
      choices: ["金融商品取引法", "資金決済法", "金融規制法", "金融サービス法"],
      comment: "金融商品取引法は、株式や債券などの金融商品の公正かつ透明な取引を確保し、投資家を保護するために設けられた法律。",
    ),
  ];

  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + 161 + 1000);
  });
}

...
List<QuizItem> get category1_17 {
  final quizItems = [
    ...
    QuizItem(
      ...
      comment: "コネクテッドカーは、インターネットや他の通信ネットワークに接続されることで、情報の共有や遠隔制御、他の車両やインフラとの通信が可能な自動車。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: '自動運転',
      ...
      comment: "自動運転は、センサーやカメラ、人工知能などを用いて、運転者の操作なしに自動車が目的地まで移動する技術。安全性の向上や運転負担の軽減が期待される。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'CASE',
    ...
    QuizItem(
      ...
      comment: "ワイヤレス給電（Wireless Power Transfer）は、電磁誘導や電磁共振などの原理を利用して、ケーブルやプラグを使用せずに電力を供給する技術。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'クラウドサービス',
    ...
    QuizItem(
      ...
      comment: "スマート農業は、センサーやドローン、ビッグデータ分析などの情報技術を農業に導入し、精密な作物管理や生産性の向上、資源の効率的な利用を図る取り組み。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'マシンビジョン',
      ...
      comment: "マシンビジョンは、カメラやセンサーを用いて取得した画像データをコンピュータが解析し、物体の検出、識別、測定などを行う技術。製造業の品質管理や自動化に広く利用される。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'HEMS',
    ...
    QuizItem(
      word: 'インダストリー4.0',
      question: '第4次産業革命とも称され、IoTやAI、ビッグデータなどの技術を製造業に統合することで、新たな産業構造を生み出す動きを何というか？',
      ans: 'インダストリー4.0',
    ...
    QuizItem(
      ...
      comment: "ロボティクスは、自動化技術や機械技術に関連する分野で、人間の代わりに物理的な作業を行う機械やシステム。製造業から医療、サービス業まで幅広く応用されている。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'ファームウェア',
  ...
  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + I18n().category1Index + 1701);
  });
}

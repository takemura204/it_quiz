...
List<QuizItem> get category1_32 {
  ...
  QuizItem(
    ...
    comment: "ロングテールは、従来のヒット商品中心の販売から脱却し、少量多品種の商品を幅広く取り揃えることで、多様なニーズに応えるビジネスモデル。",
  ),
  QuizItem(
  ...
  QuizItem(
    ...
    comment: "EC（Electronic Commerce）は、インターネットを利用した商取引のことで、オンラインショップや電子マーケットプレイスなどで商品やサービスが販売される。",
  ),
  QuizItem(
    question: 'オンラインの情報をオフラインの行動につなげるビジネスモデルを何というか？',
    ans: 'O2O',
    choices: ["EC", "O2O", "BtoC", "CtoC"],
    comment: "O2O（Online to Offline）は、オンラインでの情報やサービスを提供し、それをきっかけに消費者が実店舗を訪れるなどオフラインでの消費や行動につなげるビジネスモデル。",
  ),
  QuizItem(
    question: '企業が消費者に直接商品やサービスを提供するビジネスモデルを何というか？',
    ans: 'BtoC',
    choices: ["O2O", "BtoC", "CtoC", "BtoE"],
    comment: "BtoC（Business to Consumer）は、企業が最終消費者である個人に直接商品やサービスを販売するビジネスモデル。",
  ),
  QuizItem(
    question: '消費者が消費者に直接商品やサービスを提供する取引を何というか？',
    ans: 'CtoC',
    choices: ["BtoC", "CtoC", "BtoE", "EDI"],
    comment: "CtoC（Consumer to Consumer）は、個人間で商品やサービスが売買される取引のことで、オンラインオークションやフリーマーケットアプリなどがこのモデルに該当する。",
  ),
  QuizItem(
    question: '企業が従業員に対して直接商品やサービスを提供するビジネスモデルを何というか？',
    ans: 'BtoE',
    choices: ["CtoC", "BtoE", "EDI", "EFT"],
    comment: "BtoE（Business to Employee）は、企業が自社の従業員に対して直接商品やサービスを提供するビジネスモデル。従業員向けの福利厚生サービスなどがこれに該当する。",
  ),
  QuizItem(
  ...
  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + 311);
  });
}

...
List<QuizItem> get category1_20 {
  final quizItems = [
    ...
    QuizItem(
      ...
      choices: ["SaaS(Software as a Service)", "システムインテグレーションサービス", "ハウジングサービス", "ホスティングサービス"],
      comment:
    ...
    QuizItem(
      ...
      comment: "クラウドコンピューティングは、インターネットを通じて、サーバーやストレージなどのコンピューティングリソースをオンデマンドで提供するサービス。",
    ...
    QuizItem(
      ...
      comment: "ホスティングサービスは、ウェブサイトをインターネット上で公開するために必要なサーバーをレンタルし、その運用を代行するサービス。",
      source: '平成23年秋期 問5',
      importance: ImportanceType.normal,
    ),
    QuizItem(
  ...
  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + I18n().category1Index + 2001);
  });
}

...
List<QuizItem> get category1_14 {
  final quizItems = [
    ...
    QuizItem(
      ...
      comment: "GPS（Global Positioning System）は、地球上の任意の位置を特定するためのシステムで、衛星を利用して位置情報を提供する。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      ...
      comment: "GIS（Geographic Information System）は、地理情報を管理・分析するシステムで、空間データの可視化や解析が可能。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      ...
      comment: "ITS（Intelligent Transport Systems）は、さまざまな交通関連技術を統合して交通システム全体の効率化を目指すシステム。",
      importance: ImportanceType.low,
    ),
    QuizItem(
    ...
    QuizItem(
      ...
      comment: "CTI（Computer Telephony Integration）は、電話システムとコンピュータシステムを統合し、効率的な通信を実現する技術。",
    ...
    QuizItem(
      ...
      comment: "CDN（Content Delivery Network）は、地理的に分散されたサーバーネットワークを通じてコンテンツを迅速に配信するためのシステム。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'デジタルツイン',
      ...
      comment: "デジタルツインは、実世界のオブジェクトやプロセスのデジタル的な複製を作り、それをリアルタイムで更新することで物理とデジタルの間の連携を強化するシステム。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'サイバーフィジカルシステム',
    ...
    QuizItem(
      ...
      comment: "DTP（Desktop Publishing）は、パーソナルコンピュータと専用ソフトウェアを使用して、印刷物などのデジタルデータを作成・編集するプロセス。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: 'AI',
      ...
      comment: "AI（Artificial Intelligence）は、人間の学習や推論、自己修正などの能力を模倣し、自動的に行動やタスクを実行する技術。",
      importance: ImportanceType.low,
    ),
    QuizItem(
      word: '人間中心のAI社会原則',
  ...
  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + I18n().category1Index + 1401);
  });
}

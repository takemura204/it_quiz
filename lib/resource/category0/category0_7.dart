...
List<QuizItem> get category0_7 {
  final quizItems = [
    ...
    QuizItem(
      ...
      ans: 'ESSID',
      choices: ["ESSID", "HTTP", "MACアドレス", "IPアドレス"],
      comment: "ESSIDまたはSSIDは、無線LANネットワークの名前を示す識別子。",
    ),
    QuizItem(
      ...
      comment:
          "HTTPは、ウェブページのデータ転送に使用されるプロトコルで、ウェブサーバーとクライアント間でHTMLなどのドキュメントをやり取りする。",
    ),
    QuizItem(
  ...
  return List.generate(quizItems.length, (index) {
    return quizItems[index].copyWith(quizId: index + 61, isPremium: false);
  });
}
